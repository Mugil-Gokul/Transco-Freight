  ...
  return (
    <section className="w-full bg-white py-16 px-6 md:px-20">
      ...
      <motion.h2
        ...
        className="text-4xl md:text-5xl font-bold max-w-xl mb-12"
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {cards.map((card, index) => (
          <motion.div
            ...
            className="group bg-gray-100 rounded-xl shadow-md p-6 hover:shadow-lg transition-shadow duration-300"
          >
            {/* Title changes color when card is hovered */}
            <h3 className="text-lg md:text-xl font-semibold mb-3 text-[#18357b] group-hover:text-red-600 transition-colors duration-300">
              {card.title}
            </h3>
